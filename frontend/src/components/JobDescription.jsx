    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        <Badge className={'text-blue-700 font-bold'} variant="ghost">01 Positions</Badge>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore rem eaque fuga vel temporibus, quidem molestias, incidunt debitis veniam cum omnis minus unde? Dolores, minima autem deleniti aliquid quis distinctio.</span></h1>
